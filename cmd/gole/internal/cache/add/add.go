...
import (
	...
	"github.com/gole-dev/gole/cmd/gole/internal/utils"
...
var CmdAdd = &cobra.Command{
	...
	Long:  "Create a cache file using the cache template. Example: gole cache add UserCache",
	Run:   run,
}
