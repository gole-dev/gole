...
func GoleMod() string {
	...
	if path, err := ModuleVersion("github.com/gole-dev/gole/v2"); err == nil {
		// $GOPATH/pkg/mod/github.com/gole-dev/gole@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/github.com/gole-dev/gole
	return filepath.Join(gopath, "src", "github.com", "gole-dev", "gole")
}
